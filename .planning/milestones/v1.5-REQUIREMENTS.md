# Requirements Archive: v1.5 Reliable Infrastructure
...
- [x] **SOUL-10**: PersonaScore runs as CycleRunner post-cycle hook (not a graph node) to avoid circular evaluation and audit hash corruption
...
- [x] **KAMI-05**: KAMI fidelity dimension consumes PersonaScore continuous signal (replaces binary 0/1)
